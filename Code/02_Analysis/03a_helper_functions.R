...
gbm_get_data <- function(state2 = NULL, city2 = NULL, msa2 = NULL) {
  #### get data
...
gbm_bootstrap <- function(boot_i = NULL, state3 = NULL, city3 = NULL, msa3 = NULL) {
  
  new_df2 <- gbm_get_data(state2 = state3, city2 = city3, msa2 = msa3)[[1]]
  zone <- gbm_get_data(state2 = state3, city2 = city3, msa2 = msa3)[[2]]
...
gbm_pdp <- function(state3 = NULL, city3 = NULL, msa3 = NULL) {
  new_df2 <- gbm_get_data(state2 = state3, city2 = city3, msa2 = msa3)[[1]]
...
gbm_extract_cumulative <- function(boot_i = NULL, ref = 0.5, state3 = NULL, city3 = NULL, msa3 = NULL) {
  
  if(!(ref %in% seq(0.05, 0.95, by = 0.05))) stop("Not a valid reference")
  
  new_df2 <- gbm_get_data(state2 = state3, city2 = city3, msa2 = msa3)[[1]]
  zone <- gbm_get_data(state2 = state3, city2 = city3, msa2 = msa3)[[2]]
  df_pdp <- gbm_pdp(state3 = state3, city = city3, msa3 = msa3)
...
gbm_extract_relInf <- function(boot_i = NULL, state3 = NULL, city3 = NULL, msa3 = NULL) {
  
  zone <- gbm_get_data(state2 = state3, city2 = city3, msa2 = msa3)[[2]]
  df_pdp <- gbm_pdp(state3 = state3, city3 = city3, msa3 = msa3)
...
gbm_extract_exposure <- function(var_name, ntrees, boost, state3 = NULL, city3 = NULL, msa3 = NULL) {
...
gbm_extract_boostrap <- function(exposure, boot_i, state3 = NULL, city3 = NULL, msa3 = NULL) {
